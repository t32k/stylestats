...
module.exports = function(callback) {
    ...
    var requestPromises = this.urls.map(function(path) {
    ...
    Promise.all(requestPromises).then(function(value) {
        ...
        // Sort property count.
        var lowestDefinition = that.getDeclarationCount()
            .shift();
